...
import { SiHtml5, SiCss3, SiJavascript, SiReact, SiRedux, SiMongodb, SiGit, SiGithub, SiVercel, SiBootstrap, SiMysql, SiNetlify, SiCanva, SiFigma, SiTailwindcss } from "react-icons/si";
...
const skills = [
  ...
  { name: "Excel", icon: FaMicrosoft, color: "#217346", url: "https://www.microsoft.com/en-us/microsoft-365/excel" },
  { name: "PowerBI", icon: BiBarChartAlt2, color: "#f2c811", url: "https://powerbi.microsoft.com/" },
