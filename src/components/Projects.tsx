...
const projects = [
  {
    title: 'Aquawatt',
    description: 'A platform for track and monitor the water and electricity in each room or areas. It is a Full-stack and Iot based real time project.',
  ...
  },
  {
    ...
    description: 'My first real freelance project! where I built the website’s front-end. Clean design, responsive UI and user friendly navigation.',
  ...
  {
    title: 'FoodieHub430',
    description: 'A modern restaurant discovery platform that helps food lovers find their perfect dining experience. With an intuitive interface & powerful search capabilities.',
  ...
  },
  {
    ...
    description: 'A business website showcasing portfolio, services, client testimonials, and contact section with responsive design and modern UI/UX styling.',
  ...
  {
    title: 'Tech-Hub430',
    description: 'It is a E-commerce website which showcase the product price and details, discounts, client testimonials, our services, etc.',
    image: '/assets/techhub430.png',
    link: 'https://tech-hub430.netlify.app/',
    github: 'https://github.com/dineshit27/TechnoHacks-Ecommerce-Website-Tech-hub430',
    techStack: [
      { icon: SiHtml5, name: "HTML", color: "#e34c26" },
      { icon: SiCss3, name: "CSS", color: "#264de4" },
      { icon: SiJavascript, name: "JavaScript", color: "#f0db4f" },
