    ...
    <SectionBackground>
      <section id="services">
        <div className="container mx-auto px-6 mt-16">
          <SectionTitle subtitle="What I Offering to my clients">Services</SectionTitle>
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto mt-8">
            {services.map(({ icon: Icon, title, description, color, image }) => (
                ...
                <div className="relative bg-white dark:bg-gray-900 p-0 border border-gray-200 dark:border-gray-700 rounded-xl shadow-md hover:shadow-lg transition-transform duration-300 transform hover:-translate-y-1 overflow-hidden">
                  {image && (
                    <div className="relative overflow-hidden p-4 pb-0">
                      <img src={image} alt={title} className="w-full aspect-[1/1] object-cover rounded-lg transform group-hover:scale-105 transition-transform duration-300 ease-in-out" />
                    </div>
                  )}
                  <div className="p-6">
                    <div className="flex items-center mb-4 space-x-4">
                      {/* Icon */}
                      <div className={`p-3 ${color} rounded-lg flex items-center gap-1`}>
